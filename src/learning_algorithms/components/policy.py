...
class Policy(nn.Module):
    """
    Stochastic policy network for the actor in an actor-critic learning_algorithms.

    Attributes:
        model: Neural network model predicting the mean action
        log_std: Log standard deviation of the action distribution
        stochastic: Whether the policy is stochastic or deterministic
